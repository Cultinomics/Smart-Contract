/*
This is the source code used to deploy CULTONOMICS
CULTONOMICS is a BEP-20 token featuring:
1.8 Trillion token total supply;
6 decimal point fungibility;
15% PancakeSwap buy fees;
20% PancakeSwap sell fees;
No fees applied to other transfers;
A systematic reserve mechanic that allows for automatic token buyback and recycling.
...
contract Cultonomics is IBEP20, Manageable {
    ...
    string private _symbol = "CULT";
    uint8 private _decimals = 6;
    uint256 private _tTotal = 1800000000000 * 10**_decimals;
